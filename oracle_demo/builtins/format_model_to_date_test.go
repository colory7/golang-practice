...
func TestSuiteToDate(t *testing.T) {
	tests := []struct {
		...
		{25, "0207", "MM/YY", true},
		{25, "02#07", "MM/YY", true},
		{25, "02#07", "FMMM/YY", true},
		{25, "02#07", "FXMM/YY", true},
		{25, "2008abcd05,,20','", "YYYY\"abcd\"MM,,DD", true},
		{25, "2008abcd05,,20", "YYYY\"abcd\"MM,,DD", true},
		{25, "2008xxxx05,,20','", "YYYY\"abcd\"MM,,DD", true},
		{25, "2008\"xxxx\"05,,20','", "YYYY\"abcd\"MM,,DD", true},
		{25, "2008xxxx05,,20','", "YYYYabcdMM,,DD", true},
		{25, "15/ JAN /1998", "DD-MON-YYYY", true},
		{25, " 15! JAN % /1998", "DD-MON-YYYY", true},
		{25, "15-JAN-1998", "FXDD-MON-YYYY", true},
		{25, "15/JAN/1998", "FXDD-MON-YYYY", true},
		{25, "01-01-1998", "FXDD-MM-YYYY", true},
		{25, "1-1-1998", "FXFMDD-MM-YYYY", true},
		{25, "1-01-1998", "FXDD-MON-YYYY", true},
		{25, "02#07", "FXMM#YY", true},
		{25, "02#07", "FXMM/YY", true},
		{25, "2008 05 20", "YYYY MM DD", true},
	}
