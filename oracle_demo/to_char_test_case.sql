...
-- 系统时间 1950-1999
-- 指定时间 50-99  98
SELECT TO_CHAR(TO_CHAR('27-10-98', 'DD-MM-RR'), 'YYYY') "Year" FROM DUAL;
-- 输出 1998

-- 系统时间 1950-1999
-- 指定时间 00-49  17
SELECT TO_CHAR(TO_CHAR('27-10-17', 'DD-MM-RR'), 'YYYY') "Year" FROM DUAL;
-- 输出 2017
...
*/
SELECT TO_CHAR(TO_CHAR('27-10-1998', 'DD-MM-RR'), 'YYYY') "Year" FROM DUAL;
SELECT TO_CHAR(TO_CHAR('27-10-2017', 'DD-MM-RR'), 'YYYY') "Year" FROM DUAL;
SELECT TO_CHAR(TO_CHAR('27-10-98', 'DD-MM-RR'), 'YYYY') "Year" FROM DUAL;
SELECT TO_CHAR(TO_CHAR('27-10-17', 'DD-MM-RR'), 'YYYY') "Year" FROM DUAL;
...
-- YYYY 4位数字的年
SELECT TO_CHAR(TO_CHAR('27-OCT-98', 'DD-MON-RR'), 'YYYY') "Year" FROM DUAL;
SELECT TO_CHAR(TO_CHAR('27-OCT-17', 'DD-MON-RR'), 'YYYY') "Year" FROM DUAL;
...
SELECT TO_CHAR(TO_CHAR('0207','MM/YY'), 'MM/YY') FROM DUAL;
SELECT TO_CHAR (TO_CHAR('02#07','MM/YY'), 'MM/YY') FROM DUAL;


-- Y 最后1位数字的年
SELECT TO_CHAR(TO_CHAR('027','MM/Y'), 'MM/Y') FROM DUAL;
